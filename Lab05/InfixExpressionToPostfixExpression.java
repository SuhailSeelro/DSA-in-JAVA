public class InfixExpressionToPostfixExpression {
    ...
    InfixExpressionToPostfixExpression(int size) {
        this.size = size;
        arr = new char[size];
    }
    ...
    public static void main(String[] args) {
        InfixExpressionToPostfixExpression converter = new InfixExpressionToPostfixExpression(20); // Stack size 100 for simplicity
